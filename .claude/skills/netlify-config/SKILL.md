---
name: netlify-config
description: Guide for netlify.toml file-based configuration. Use when configuring build settings, redirects, headers, deploy contexts, environment variables, functions, edge functions, or plugins in netlify.toml.
---
...
**Do not put secrets in netlify.toml** (it's committed to source control). Use the Netlify UI or CLI for sensitive values.
