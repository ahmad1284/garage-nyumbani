...
description: Guide for Netlify CLI commands, deployments, local development with netlify dev, and environment variable management. Use when deploying, running local dev, or managing environment variables.
---
...
Then run your normal dev command (`npm run dev`) — no `netlify dev` wrapper needed.
